  ...
  return (
    <MainContent type="center">
      ...
      <div className="flex flex-col lg:flex-row space-y-5 lg:space-y-0 lg:space-x-5 items-start lg:items-center">
        ...
        >
          <div className="z-10 flex flex-row space-x-2 items-center text-violet-600 group-hover:text-neutral-100 transition-all duration-300 ease-in-out">
        ...
        >
          <div className="z-10 flex flex-row space-x-2 items-center group-hover:text-violet-600">
