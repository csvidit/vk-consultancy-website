...
const WhyUs = () => {
  return (
    <div
      id="why-us"
      className={
        "min-w-screen min-h-screen h-full flex flex-col space-y-5 lg:space-y-10 bg-transparent justify-center p-5 lg:p-10 text-neutral-100 dark:text-neutral-900 selection:text-neutral-900 selection:bg-neutral-100 selection:dark:text-neutral-100 selection:dark:bg-neutral-900 " +
    ...
    >
      <div className="flex flex-col lg:flex-row space-y-5 lg:space-y-0 lg:justify-between lg:items-center">
        <div className="flex flex-col space-y-1">
          ...
          <div className="dark:text-neutral-600 text-neutral-400 font-light">Scroll for more </div></div>
            ...
            <WhyUsCardContainer>
              <WhyUsCard>
                ...
                <WhyUsContent>
                  ...
                  <WhyUsText>
                    Never worry about increasing prices again. Starting at just
                    $50, two revisions included.
                  </WhyUsText>
                </WhyUsContent>
              </WhyUsCard>
            </WhyUsCardContainer>
              ...
              <WhyUsCard>
                ...
                <WhyUsContent>
                  ...
                  <WhyUsText>
                    ...
                    technologies. Say bye-bye to old, clunky websites or
                    designs. Say hello to your unrealized business potential.
                  </WhyUsText>
                </WhyUsContent>
              </WhyUsCard>
            </WhyUsCardContainer>
              ...
              <WhyUsCard>
                ...
                <WhyUsContent>
                  ...
                  <WhyUsText>
                    ...
                    service of your website. Pay only for the work you need, by
                    the hour. No overheads.
                  </WhyUsText>
                </WhyUsContent>
              </WhyUsCard>
            </WhyUsCardContainer>
